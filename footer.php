     ...
     <footer class="footer-one">
      <div class="footer-one__bg" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/backgrounds/footer-bg.jpg);">
      </div>
      <div class="shape1 float-bob-x"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/shapes/footer-v1-shape1.png" alt="#"></div>
      <div class="shape2 float-bob-y"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/shapes/footer-v1-shape2.png" alt="#"></div>
      <div class="shape3 float-bob-y"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/shapes/footer-v1-shape3.png" alt="#"></div>
      <div class="shape4 float-bob-x"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/shapes/footer-v1-shape4.png" alt="#"></div>
         ...
         <div class="col-xl-3 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s">
          <div class="footer-one__single footer-one__about">
           <div class="footer-one__about-logo">
            <a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/resources/footer-logo.png" alt=""></a>
           </div>
          ...
          <div class="footer-one__single footer-one__post">
           ...
           <div class="footer-one__post-box">
            <ul class="footer-one__post-list">
             <li>
              <div class="img-box">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/images/resources/footer-v1-img1.jpg" alt="#">
              </div>
             ...
             <li>
              <div class="img-box">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/images/resources/footer-v1-img2.jpg" alt="#">
              </div>
         ...
         <div class="col-xl-12">
          <div class="footer-one__bottom-inner">
           ...
           <div class="footer-one__bottom-right">
            <p>©2023 <a href="index.html">Ontech</a> All Rights Reserved</p>
           </div>
          </div>
         </div>
        </div>
    ...
    <div class="mobile-nav__wrapper">
     ...
     <div class="mobile-nav__content">
      ...
      <div class="logo-box">
       <a href="index.html" aria-label="logo image"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/resources/footer-logo.png"
        width="143" alt="" /></a>
       </div>
       <!-- /.logo-box -->
     ...
     <script src="<?php echo get_template_directory_uri(); ?>/assets/vendors/polyglot-language-switcher/jquery.polyglot.language.switcher.js"></script>
     <script src="<?php echo get_template_directory_uri(); ?>/assets/vendors/progress-bar/knob.js"></script>

     <!-- template js -->
     <script src="<?php echo get_template_directory_uri(); ?>/assets/js/ontech.js"></script>
    ...
    <!-- Mirrored from bracketweb.com/ontech-html/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Aug 2023 02:15:52 GMT -->
    </html>